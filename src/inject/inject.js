...
chrome.extension.sendMessage({}, function(response) {
	...
	if (document.readyState === "complete") {
		...
		const approveMergeNode = '<button id="approve-merge" style="' + styles +'">Approve, Squash and merge</button>'
		...
		// $('body').prepend(developAlphaNode); this will enable develop -> alpha merge button (not tested)
